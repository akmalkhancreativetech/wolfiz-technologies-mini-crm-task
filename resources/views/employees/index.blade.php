                ...
                @if(count($employees))
                    ...
                    <x-table>
                        <x-slot name="header">
                            ...
                            <x-table-column>Company</x-table-column>
                            <x-table-column>Actions</x-table-column>
                        </x-slot>
                        @foreach($employees as $employee)
                            <tr>
                                <x-table-column>{{ $employee->id }}</x-table-column>
                                <x-table-column><a href="{{ route('employees.show', $employee) }}">{{ $employee->first_name }}</a></x-table-column>
                                <x-table-column>{{ $employee->last_name }}</x-table-column>
                                <x-table-column>{{ $employee->email }}</x-table-column>
                                <x-table-column>{{ $employee->phone }}</x-table-column>
                                <x-table-column>{{ $employee->company->name }}</x-table-column>
                                <x-table-column>
